...
const CreateEstate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("/api/estate/createEstate" , {
                ...formData ,
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-7'>
            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <button disabled={loading || imageUploded} className='p-3 rounded-lg bg-slate-700 text-white capitalize hover:opacity-90 disabled:opacity-80'>{loading ? "Creating..." : "Create Estate"}</button>
